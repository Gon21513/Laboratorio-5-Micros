...
BSF ((OSCCON) and 07Fh), 5 ;1 en el bit 5
BCF ((OSCCON) and 07Fh), 4 ; 0 en el bit 4
...
; RETURN
 ...
 SUB_CENTENAS:
    ...
    BTFSC STATUS, 0 ; C CHEQUEAR LA BANDERA DE ((STATUS) and 07Fh), 0
    GOTO $-4 ; VOLVER A EJECUTAR
    DECF CENTENAS ; DECREMENTAR EN 1 LAS CENTENAS
    MOVLW 100 ; CARGARMOS 100 A W
    ADDWF VALOR, F ; SUMAMOS 100 A VALUE PARA NO VOLVER A ACTIVAR EL ((STATUS) and 07Fh), 0
    RETURN
 ...
 SUB_DECENAS:
    ...
    ADDWF VALOR, F ; SUMAMOS 10 A VALUE PARA NO VOLVER A ACTIVAR EL ((STATUS) and 07Fh), 0
    RETURN
